...
ghg_observed = pd.read_csv(wc_path+"/App/data/raw/table_A3.1_historical_abundances.csv", skiprows=37, skipfooter=1,encoding="unicode_escape", usecols=["YYYY", "CO2", "CH4", "N2O"], engine="python")
ghg_observed.rename(columns={"YYYY":"year","CO2":"gemessen","CH4":"ch4","N2O":"n2o"}, inplace=True)

co2_projections = pd.read_excel(wc_path+"/App/data/raw/IPCC_AR6_AnnexIII_Tab2_future_co2_concentration.xlsx")
...
co2_concentration_total.to_csv(wc_path+"/App/data/co2_concentration_total.csv",index=False)
