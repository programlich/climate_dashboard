...
# Select only global emissions and swap cols with rows
...
# prediction for the upcoming months/years are calculated with the average from 2015 to 2021.
...
global_avg_15_21 = global_total.loc[global_total["year"].isin([2015, 2016, 2017, 2018, 2019, 2021]), "total_emissions"].\
    mean()
...
budget.to_csv("../../data/clean/emissions_gauge.csv", index=False)
